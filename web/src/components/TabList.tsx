  ...
  if (active) {
    return (
      <li role="presentation">
        <Link
          className="inline-flex items-center justify-center w-full h-10 gap-2 px-5 -mb-px text-sm font-medium tracking-wide transition duration-300 border-b-2 rounded-t focus-visible:outline-none whitespace-nowrap border-emerald-500 hover:border-emerald-600 focus:border-emerald-700 text-emerald-500 hover:text-emerald-600 focus:text-emerald-700 hover:bg-emerald-50 focus:bg-emerald-50 disabled:cursor-not-allowed disabled:border-slate-500 stroke-emerald-500 hover:stroke-emerald-600 focus:stroke-emerald-700"
          role="tab"
          to={tab.url}
          aria-selected="true"
        >
