...
export async function NewMqttProfileAction(
  api: ApiService,
  ...
  return redirect("/mqtt/edit-profile/" + id);
}

export default function MqttNewProfile() {
  return (
    <div className="max-w-xl mx-auto">
      <h1 className="text-2xl font-bold text-slate-800">New MQTT Profile</h1>
      <p className="mt-2 text-slate-600">
        Create a new MQTT profile to define access permissions.
      </p>
